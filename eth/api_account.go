...
func (api *PublicAccountAPI) GetTotalAmount(ctx context.Context, addr common.Address) (*types.AccountAmountInfo, error) {
	return contract_api.GetAccountTotalAmount(ctx, api.blockChainAPI, addr)
}

func (api *PublicAccountAPI) GetAvailableAmount(ctx context.Context, addr common.Address) (*types.AccountAmountInfo, error) {
...
func (api *PublicAccountAPI) GetRecords(ctx context.Context, addr common.Address) ([]types.AccountRecord, error) {
	return contract_api.GetAccountRecords(ctx, api.blockChainAPI, addr)
}

func (api *PublicAccountAPI) GetRecord0(ctx context.Context, addr common.Address) (*types.AccountRecord, error) {
	return contract_api.GetAccountRecord0(ctx, api.blockChainAPI, addr)
}

func (api *PublicAccountAPI) GetRecordByID(ctx context.Context, id *big.Int) (*types.AccountRecord, error) {
	return contract_api.GetAccountRecordByID(ctx, api.blockChainAPI, id)
}

func (api *PublicAccountAPI) GetRecordUseInfo(ctx context.Context, id *big.Int) (*types.AccountRecordUseInfo, error) {
	return contract_api.GetAccountRecordUseInfo(ctx, api.blockChainAPI, id)
}
