...
func (c *Console) initMasterNode(vm *goja.Runtime, bridge *bridge) {
	...
	getJeth(vm).Set("getOfficialMasterNodeNum", masternode.Get("getOfficialNum"))
	...
	masternode.Set("getOfficialNum", jsre.MakeCallback(vm, bridge.GetOfficialMasterNodeNum))
...
func (c *Console) initSuperNode(vm *goja.Runtime, bridge *bridge) {
	...
	getJeth(vm).Set("getOfficialSuperNodeNum", supernode.Get("getOfficialNum"))
	...
	supernode.Set("getOfficialNum", jsre.MakeCallback(vm, bridge.GetOfficialSuperNodeNum))
