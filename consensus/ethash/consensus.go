...
func (ethash *Ethash) FinalizeAndAssemble(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt, update bool) (*types.Block, []*types.Transaction, []*types.Receipt, error) {
	// Finalize block
	ethash.Finalize(chain, header, state, txs, uncles)

	// Header seems complete, assemble into a block and return
	return types.NewBlock(header, txs, uncles, receipts, trie.NewStackTrie(nil)), txs, receipts, nil
}
...
func (ethash *Ethash)CheckRewardTransaction(block *types.Block, receipts types.Receipts) error {
	return nil
}
